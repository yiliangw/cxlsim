...
$(o)ubuntu_mysql.log: $(d)exps/ubuntu_mysql.yaml $(ubuntu_dimg_o)gateway/disk.qcow2 $(ubuntu_dimg_o)gateway/disk.raw $(ubuntu_dimg_o)controller/disk.qcow2 $(ubuntu_dimg_o)controller/disk.raw $(ubuntu_dimg_o)compute1/disk.qcow2 $(ubuntu_dimg_o)compute1/disk.raw $(ubuntu_vmlinux)
